...
const WhatsAppButton = () => {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="flex fixed bottom-6 right-5 md:bottom-8 md:right-8 z-50 w-16 h-16 md:w-20 md:h-20 items-center justify-center group"
      aria-label="Fale conosco pelo WhatsApp"
    >
      <motion.div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 md:w-10 md:h-10 bg-[#25D366] rounded-full -z-10"
